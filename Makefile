# This Makefile is for the Animal extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Animal.pm]
#     AUTHOR => [q[Vasil Ivanov <mastervasil@gmail.com>]]
...
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Animal.pm]
#     clean => { FILES=>q[Animal-*] }
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /Users/vasil/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /Users/vasil/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.98
MM_REVISION = 69800
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Vasil Ivanov <mastervasil@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Animal' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Vasil Ivanov <mastervasil@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Animal",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Vasil Ivanov &lt;mastervasil@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  lib/Animal.pm blib/lib/Animal.pm \
	  lib/Cow.pm blib/lib/Cow.pm \
	  lib/Horse.pm blib/lib/Horse.pm \
	  lib/LivingCreature.pm blib/lib/LivingCreature.pm \
	  lib/Mouse.pm blib/lib/Mouse.pm \
	  lib/Person.pm blib/lib/Person.pm \
	  lib/Sheep.pm blib/lib/Sheep.pm 
